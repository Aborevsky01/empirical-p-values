...
\begin{figure}[h!]
	...
	\begin{tabular}{cccc}
		...
		\includegraphics[width=1.7in]{img/cnn_QQ_pcam.png} &
		\includegraphics[width=1.7in]{img/cnn_pcam_fdr_control.png} & 
		\includegraphics[width=1.7in]{img/cnn_pcam_fdr_control_loc.png} &
		\includegraphics[width=1.7in]{img/cnn_FDPscat_pcam.png}\\	
...
\begin{figure}[h!]
	...
	\begin{tabular}{cccc}
        ...
        \includegraphics[width=1.7in]{img/cnn_QQ_old_DELETE.png} &
		\includegraphics[width=2in]{img/cnn_old_DELETE_fdr_control.png} &
		\includegraphics[width=2in]{img/cnn_old_DELETE_fdr_control_loc.png}  &
		\includegraphics[width=1.7in]{img/cnn_FDPscat_old_DELETE.png}\\	
		A & B & C & D
	\end{tabular}
	\caption{{\bf Performance evaluation of FDR controlling methods.}  See the caption of Figure \ref{fig:mnist_shfit} for plot descriptions.}
	\label{fig:ii}
