...
\begin{figure}[h!]
	\begin{tabular}{ccc}
        ...
        \includegraphics[width=0.225\linewidth, height=0.225\linewidth]{img/0th_class_bcss_dist .png} 		&
		\includegraphics[width=0.225\linewidth, height=0.225\linewidth]{img/1st_class_bcss_dist.png} & 
		\includegraphics[width=0.225\linewidth, height=0.225\linewidth]{img/2nd_class_bcss_dist.png} \\
		A & B & C
	\end{tabular}
	\caption{{\bf BCSS dists 0 - 1 - 2 classes. }}
	\label{fig:I}
\end{figure} 
