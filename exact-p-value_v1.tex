...
\begin{figure}
	\centering
	\begin{tabular}{ccc}
 		\includegraphics[width=2in]{misc/QQ_with_labels.png} &
		\includegraphics[width=2in]{misc/test_pred_with_labels.png} & 
            \includegraphics[width=2in]
            {misc/test_pred_with_labels_loc.png}
		\\
		%    \includegraphics[width=3in]{digestion.pdf} & \includegraphics[width=3in]{cleavages.pdf} \\		
		A & B & C\\
            \includegraphics[width=2in]{misc/QQ_no_labels.png} &
		\includegraphics[width=2in]{misc/test_pred_no_labels.png} &  
            \includegraphics[width=2in]{misc/test_pred_no_labels_loc.png}  \\
		D & E & F \\
	\end{tabular}
