...
\subsection{FWER-based approach}
...
\begin{figure}
	\centering
	\begin{tabular}{ccc}
 		\includegraphics[width=2in]{img/pcam_QQ.jpeg} &
		\includegraphics[width=2in]{img/pcam_fdr_control.jpeg} & 
            \includegraphics[width=2in]{img/pcam_fdr_control_loc.jpeg}
		\\	
		A & B & C
	\end{tabular}
