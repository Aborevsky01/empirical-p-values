...
\begin{figure}
	\centering
	\begin{tabular}{ccc}
 		\includegraphics[width=2in]{img/pcam_QQ.pdf} &
		\includegraphics[width=2in]{img/pcam_fdr_control.pdf} & 
            \includegraphics[width=2in]{img/pcam_fdr_control_loc.pdf}
		\\	
		A & B & C
	\end{tabular}
...
\begin{figure}
	\centering
	\begin{tabular}{ccc}
 		\includegraphics[width=2in]{img/pcam_balanced_QQ.pdf} &
		\includegraphics[width=2in]{img/pcam_balanced_fdr_control.pdf} & 
            \includegraphics[width=2in]{img/pcam_balanced_fdr_control_loc.pdf}
		\\	
		A & B & C
	\end{tabular}
