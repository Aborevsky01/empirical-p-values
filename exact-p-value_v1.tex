...
\begin{figure}
    \centering
	\begin{tabular}{cc}
		\includegraphics[width=2in]{misc/QQ_multi.png} &
		\includegraphics[width=2in]{misc/test_pred_multi.png} \\	
		A & B \\
	\end{tabular}
...
\begin{figure}
    \centering
        \begin{tabular}{ccc}
 		\includegraphics[width=2in]{misc/QQ_shift_binary_with.png} &
		\includegraphics[width=2in]{misc/shift_test_pred_with_labels.png} & 
            \includegraphics[width=2in]
            {misc/shift_test_pred_with_labels_loc.png}
		\\	
		A & B & C\\
            \includegraphics[width=2in]{misc/QQ_shift_binary_no.png} &
		\includegraphics[width=2in]{misc/shift_test_pred_no_labels.png} &  
            \includegraphics[width=2in]{misc/shift_test_pred_no_labels_loc.png}  \\
		D & E & F \\
	\end{tabular}
