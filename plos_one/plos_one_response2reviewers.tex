...
\response{We agree, and we already state this limitation explicitly in our Conclusion: TNA is presented as a practical heuristic, not as a method with proven error bounds. We have kept it:}
