...
\\
Andrey Borevskiy\textsuperscript{1\Yinyang},
Attila Kertesz-Farkas\textsuperscript{1\Yinyang},
\\
\bigskip
...
\toprule
\textbf{Dataset} & \textbf{Full Name} & \textbf{Repository} & \textbf{Accession / URL} \\
\midrule
MNIST & MNIST Database of Handwritten Digits & Yann LeCun's Website; UCI ML Repository & DOI: \href{https://doi.org/10.24432/C53K8Q}{10.24432/C53K8Q}; \url{http://yann.lecun.com/exdb/mnist/} \\
\addlinespace
BCSS & Breast Cancer Semantic Segmentation Dataset & GitHub & DOI: \href{https://doi.org/10.1093/bioinformatics/btz083}{10.1093/bioinformatics/btz083}; \url{https://github.com/PathologyDataScience/BCSS} \\
\addlinespace
CheXpert & CheXpert Chest X-ray Dataset & Stanford AIMI & \url{https://aimi.stanford.edu/datasets/chexpert-chest-x-rays} \\
\addlinespace
PatchCamelyon & PatchCamelyon (PCam) Benchmark Dataset & Zenodo & DOI: \href{https://doi.org/10.5281/zenodo.2546921}{10.5281/zenodo.2546921} \\
\addlinespace
TissueNet & TissueNet Cell Segmentation Dataset & DeepCell Datasets & DOI: \href{https://doi.org/10.1038/s41587-021-01094-0}{10.1038/s41587-021-01094-0}; \url{https://datasets.deepcell.org/} \\
\bottomrule
\end{tabularx}
\end{table}
...
\bibliography{plos/bibliography}
